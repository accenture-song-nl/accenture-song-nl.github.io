...
function getAnimation(){
    ...
    masterTL.to("#logoWrapper", 0.4, {height:253, ease:Sine.easeInOut})
    ...
    masterTL.to("#text1", 0.3, {top:40, ease:Sine.easeOut}, "-=0.3")
    masterTL.to("#endText", 0.4, {top: 155})
    masterTL.from("#endText", 0.3, {opacity:0, ease:Sine.easeOut}, "-=0.1")
