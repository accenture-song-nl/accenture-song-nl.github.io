...
function getAnimation(){
    ...
    masterTL.to("#logoWrapper", 0.4, {width:276, height:126, ease:Sine.easeInOut})
    masterTL.from(split.words, {opacity: 0, x:-10, ease:Sine.easeOut, stagger: 0.02});
    masterTL.from("#cta", 0.5, {scale:0, opacity:0, ease:Back.easeOut})
    masterTL.to("#logoWrapper", 0.4, {height:224, ease:Sine.easeInOut}, "+=1")
    masterTL.to("#text1", 0.4, {top: 22, width: 216}, "-=0.4")
    masterTL.from("#endText", 0.4, {top: 28}, "-=0.2")
    masterTL.from("#endText", 0.3, {opacity:0, ease:Sine.easeOut}, "-=0.2")
    masterTL.from("#renteCircle", 0.4, {scale: 0})
    masterTL.from("#disclaimerText", 0.4, {scale: 0}, "-=0.4")
