...
function getAnimation(){
    ...
    masterTL.to("#logoWrapper", 0.4, {width:395, height:80, ease:Sine.easeInOut})
    masterTL.to("#logo", 0.4, {width: 115, bottom: 23, right: 6, ease:Sine.easeInOut}, "-=0.4")
    ...
    masterTL.to("#logoWrapper", 0.4, {width:718, ease:Sine.easeInOut}, "+=1")
    ...
    masterTL.from("#disclaimerText", 0.4, {scale: 0}, "-=0.1")
