...
function getAnimation(){
    ...
    masterTL.from(["#footer", "#logo", "#gradient"], 1, {y:200, ease:Sine.easeOut}, "start+=1")
    masterTL.from("#text1", 0.5, {x:-170, ease:Sine.easeOut}, "start+=2")
    ...
    masterTL.from("#text3A", 0.5, {x:-170, ease:Sine.easeOut}, "frame3+=1")
    masterTL.from("#text3B", 0.5, {x:-250, ease:Sine.easeOut}, "frame3+=1.2")
    masterTL.from("#text3C", 0.5, {x:-170, ease:Sine.easeOut}, "frame3+=1.4")
    ...
    masterTL.from("#text4A", 0.5, {x:-170, ease:Sine.easeOut}, "frame4+=1")
