...
function getAnimation(){
    ...
    masterTL.from("#cta", 0.5, {scale:0, ease:Back.easeOut}, "start+=0.5")
    // masterTL.from(["#footer", "#logo", "#gradient"], 1, {y:250, ease:Sine.easeOut}, "start+=1")
    masterTL.from("#text1", 0.5, {x:-250, opacity:0, ease:Sine.easeOut}, "start+=2")
    masterTL.to(["#bg1", "#text1"], 0.5, {opacity:0, ease:Sine.easeOut}, "start+=4")
    
    masterTL.add("frame2", "-=0.5");
    masterTL.to("#bg2", 1.5, {scale:1.2, x:-100, y:40, ease:Sine.easeInOut}, "frame2+=1")
    masterTL.from("#text2", 0.5, {x:-170, opacity:0, ease:Sine.easeOut}, "frame2+=2")
    masterTL.from("#darken", 0.5, {opacity:0, ease:Sine.easeOut}, "frame2+=2")
    masterTL.to(["#text2", "#darken"], 0.5, {opacity:0, ease:Sine.easeOut}, "frame2+=4")
    masterTL.to(["#bg2"], 0.1, {opacity:0, ease:Sine.easeOut}, "frame2+=4")

    masterTL.add("frame3", "-=0.5");
    masterTL.from("#bg3", 1.5, {scale:1.2, x:-100, y:40, ease:Sine.easeInOut}, "frame3")
    masterTL.from("#text3A", 0.5, {x:-250, opacity:0, ease:Sine.easeOut}, "frame3+=1")
    masterTL.from("#text3B", 0.5, {x:-250, opacity:0, ease:Sine.easeOut}, "frame3+=1.2")
    masterTL.from("#text3C", 0.5, {x:-250, opacity:0, ease:Sine.easeOut}, "frame3+=1.4")
    masterTL.to(["#bg3", "#text3A", "#text3B", "#text3C"], 0.5, {opacity:0, ease:Sine.easeOut}, "frame3+=6")
    
    masterTL.add("frame4", "-=0.5");
    masterTL.from("#bg4", 1.5, {scale:1.2, ease:Sine.easeInOut}, "frame4")
    masterTL.from("#text4A", 0.5, {x:-250, opacity:0, ease:Sine.easeOut}, "frame4+=1")
