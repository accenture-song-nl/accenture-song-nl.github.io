...
function onInit() {
  ...
  masterTL.add('start');
  masterTL.to('#banners', 0.1, {onStart:function(){
    gsap.to('#bg', 3, {x:-200, ease:Sine.easeInOut});
  }}, 'start');
  masterTL.from('#graph', 0.5, {scale:0, transformOrigin:"50% 90%", ease:Sine.easeInOut}, 'start+=0.5');
  masterTL.from('#graphArrowWrapper', 0.5, {scale:0, transformOrigin:"50% 50%", ease:Sine.easeInOut}, 'start+=0.5');
  masterTL.add("graph");
  masterTL.to('#graphArrow', 0.2, {rotation:20, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:5, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:20, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:10, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:17, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:15, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:17, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:20, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:-5, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:10, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.15, {rotation:-15, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.15, {rotation:15, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:5, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:-5, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:0, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:15, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:1, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:10, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:15, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:10, ease:Sine.easeInOut});
  masterTL.to('#graphArrow', 0.1, {rotation:17, ease:Sine.easeInOut});
  ...
  masterTL.to('#graphArrow', 0.1, {rotation:-5, ease:Sine.easeInOut});
  masterTL.add("frame2");
  masterTL.to("#bg", .5, {opacity:0, ease:Sine.easeInOut}, "frame2");
  masterTL.from("#bg2", .5, {opacity:0, ease:Sine.easeInOut}, "frame2");
