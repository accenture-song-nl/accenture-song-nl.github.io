...
function getAnimation(){
    ...
    masterTL.from("#brochure", 1, {scale:1.9, y:80, x:-93, rotation:-4, ease:Power2.easeInOut}, "start+=2.7")
    ...
    masterTL.to(["#logo", "#topic1", "#topic2", "#topic3", "#brochure", "#stars1"], 0.5, {opacity:0, ease:Sine.easeInOut}, "8.2")
