...
function getAnimation(){
    ...
    masterTL.add("start");
    masterTL.from("#bg", 1.5, {scale:1.2, transformOrigin:"50% 20%", ease:Power2.easeInOut}, "start")
    masterTL.from("#person", 1.5, {scale:1.6, transformOrigin:"50% 20%", ease:Power2.easeInOut}, "start")
    ...
    masterTL.to("#person", 5, {scale:1.15, transformOrigin:"50% 20%", ease:Sine.easeInOut}, "showText2")
