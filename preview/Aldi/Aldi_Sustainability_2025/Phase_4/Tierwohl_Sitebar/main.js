...
function getAnimation(){
    ...
    masterTL.from("#sticker3", 0.5, {y:1000, ease:Sine.easeOut}, "showStickerFrame+=0.4")
    // masterTL.to(["#text1", "#text1HighlightWrapper", "#sticker", "#sticker2"], 0.5, {opacity:0, ease:Sine.easeInOut}, "showStickerFrame+=3.5")
    masterTL.to(["#text1", "#text1B", "#text1HighlightWrapper", "#sticker", "#sticker2", "#sticker3"], 0.5, {opacity:0, ease:Sine.easeInOut}, "showStickerFrame+=3.5")
