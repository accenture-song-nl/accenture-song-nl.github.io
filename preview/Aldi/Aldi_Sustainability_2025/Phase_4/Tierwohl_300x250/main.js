...
function getAnimation(){
    ...
    masterTL.to(["#text1", "#text1B", "#text1HighlightWrapper"], 0.5, {y:-98, ease:Sine.easeInOut}, "showFrame2+=1")
    ...
    masterTL.from("#sticker3", 0.5, {y:150, ease:Sine.easeOut}, "showStickerFrame+=0.4")
