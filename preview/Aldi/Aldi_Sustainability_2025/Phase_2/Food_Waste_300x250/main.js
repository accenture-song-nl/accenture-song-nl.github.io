...
function getAnimation(){
    ...
    masterTL.to(["#text1", "#text1B", "#text1HighlightWrapper"], 0.5, {y:-250, ease:Sine.easeInOut}, "showFrame2+=1")
    masterTL.from("#text2", 0.5, {y:200, ease:Sine.easeOut}, "showFrame2+=1.5")
    masterTL.from("#sticker", 0.5, {y:150, ease:Sine.easeOut}, "showFrame2+=1.8")
