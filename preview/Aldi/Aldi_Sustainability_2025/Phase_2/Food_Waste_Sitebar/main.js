...
function getAnimation(){
    ...
    masterTL.to(["#text1", "#text1B", "#text1HighlightWrapper"], 0.5, {opacity:0, ease:Sine.easeInOut}, "showFrame2+=1")
    masterTL.from("#text2", 0.5, {y:1000, ease:Sine.easeOut}, "showFrame2+=1.5")
    masterTL.from("#sticker", 0.5, {y:1000, ease:Sine.easeOut}, "showFrame2+=1.8")
    masterTL.to(["#text2"], 0.5, {opacity:0, ease:Sine.easeInOut}, "showFrame2+=4.5")
    masterTL.to("#sticker", 0.5, {opacity:0, ease:Sine.easeInOut}, "showFrame2+=4.8")
    ...
    masterTL.from("#text4HighlightWrapper", 0.5, {y:1000, ease:Sine.easeOut}, "showFrame3+=2")
    masterTL.from(["#text3HighlightWrapper"], 0.5, {width:0, ease:Sine.easeOut}, "showFrame3+=2.7")
