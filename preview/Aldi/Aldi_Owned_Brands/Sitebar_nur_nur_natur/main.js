...
function getAnimation(){
    ...
    masterTL.from("#endBg", 0.5, {opacity:0, ease:Sine.easeIn}, "intro+=12.5")
    masterTL.from("#endLogo", 0.5, {opacity:0, y:20, ease:Sine.easeIn}, "intro+=13")
    masterTL.from("#ctaLeft", 0.5, {scale:0, transformOrigin:"50% 70%", ease:Back.easeOut}, "intro+=13.5");
    masterTL.from("#ctaRight", 0.01, {opacity:0, ease:Sine.easeOut}, "intro+=14.2");
    masterTL.from("#ctaRight", 0.3, {x:-50, ease:Sine.easeOut}, "intro+=14.2");
