...
function getAnimation(){
    ...
    masterTL.to(["#product1Price", "#product1PriceBg", "#product1PriceTop", "#product1PriceTopText", "#product1Disclaimer"], 0.5, {x:18, ease:Sine.easeInOut}, "frame2")
    ...
    masterTL.to(["#product1Price", "#product1PriceBg", "#product1PriceTop", "#product1PriceTopText", "#product1Disclaimer"], 0.5, {x:300, ease:Sine.easeIn}, "frame7")
