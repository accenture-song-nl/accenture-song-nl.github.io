...
function getAnimation(){
    ...
    gsap.set("#product1", {scale:0.78, x:92, y:68});
    gsap.set("#product2", {scale:0.63, x:39, y:415});
    ...
    masterTL.from("#panelLeft", 0.5, {x:900, ease:Power2.easeOut}, "start+=.3")
    masterTL.from("#product2", 0.5, {x:900, ease:Sine.easeOut}, "start+=.5")
    masterTL.from("#text1B", 0.5, {x:900, ease:Sine.easeOut}, "start+=.6")
    ...
    masterTL.to(["#mainText", "#highlight1Wrapper"], 0.5, {x:-900, ease:Sine.easeIn}, "frame3")
    ...
    masterTL.to("#scaler", 0.5, {background:"#7CBC32", ease:Sine.easeIn}, "frame3")
    ...
    masterTL.to("#panelRight", 0.5, {x:900, ease:Sine.easeIn}, "frame4+=0.5")
    masterTL.to("#scaler", 0.5, {background:"#B0D784", ease:Sine.easeIn}, "frame4+=1")
    ...
    masterTL.to("#panelRight2", 0.5, {x:900, ease:Sine.easeIn}, "frame5+=0.5")
