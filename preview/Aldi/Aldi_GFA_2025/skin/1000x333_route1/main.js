...
function getAnimation(){
    ...
    masterTL.from("#product1Info", 0.5, {x:900, ease:Sine.easeOut}, "frame3+=0.5")
    ...
    masterTL.to("#product1Info", 0.5, {x:900, ease:Sine.easeIn}, "frame4+=0.5")
    masterTL.to("#product1", 0.5, {x:900, ease:Sine.easeIn}, "frame4+=0.5")
    masterTL.to("#panelRight", 0.5, {x:1100, ease:Sine.easeIn}, "frame4+=0.5")
    ...
    masterTL.from("#product2Info", 0.5, {x:900, ease:Sine.easeOut}, "frame4+=1.3")
    ...
    masterTL.to("#product2Info", 0.5, {x:900, ease:Sine.easeIn}, "frame5+=0.5")
    masterTL.to("#product2", 0.5, {x:900, ease:Sine.easeIn}, "frame5+=0.5")
    masterTL.to("#panelRight2", 0.5, {x:1100, ease:Sine.easeIn}, "frame5+=0.5")
    ...
    masterTL.to("#product3", 0.5, {x:0, ease:Sine.easeOut}, "frame8+=0.5")
    masterTL.from("#product3Info", 0.5, {x:900, ease:Sine.easeOut}, "frame8+=0.5")
    masterTL.from("#product3Price", 0.5, {scale:0, ease:Power4.easeOut}, "frame8+=1")

    masterTL.add("frame9", "+=1");
    masterTL.to("#product3Price", 0.5, {scale:0, ease:Power4.easeIn}, "frame9")
    masterTL.to("#product3Info", 0.5, {x:900, ease:Sine.easeIn}, "frame9+=0.5")
    masterTL.to("#product3", 0.5, {x:900, ease:Sine.easeIn}, "frame9+=0.5")
    masterTL.to("#panelRight3", 0.5, {x:1100, ease:Sine.easeIn}, "frame9+=0.5")
    ...
    masterTL.to("#product4", 0.5, {x:0, ease:Sine.easeOut}, "frame9+=1.3")
    masterTL.from("#product4Info", 0.5, {x:900, ease:Sine.easeOut}, "frame9+=1.3")
    masterTL.from("#product4Price", 0.5, {scale:0, ease:Power4.easeOut}, "frame9+=1.8")
