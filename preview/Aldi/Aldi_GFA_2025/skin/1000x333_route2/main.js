...
function getAnimation(){
    ...
    masterTL.from("#product1PriceTop", 1, {y:-100, ease:Power2.easeOut}, "start+=1")
    ...
    masterTL.from("#text1B", 0.5, {x:300, ease:Sine.easeOut}, "start+=2")
    ...
    masterTL.to(["#product1Price", "#product1PriceBg", "#product1PriceTop", "#product1PriceTopText", "#product1Disclaimer"], 0.5, {x:500, ease:Sine.easeIn}, "frame2")
    ...
    masterTL.from(["#product2PriceBg", "#product2PriceTopText"], 0.5, {scale:0, ease:Back.easeOut}, "frame3+=.5")
    masterTL.from("#product2PriceTop", 1, {y:-100, ease:Power2.easeOut}, "frame3+=1")
    masterTL.from("#product2Disclaimer", 0.5, {opacity:0, y:-20, ease:Back.easeOut}, "frame3+=1.5")
    masterTL.from("#product2Price", 0.5, {scale:0, ease:Back.easeOut}, "frame3+=1.8")
    masterTL.from("#text2B", 0.5, {x:300, ease:Sine.easeOut}, "frame3+=2")   
    ...
    masterTL.to(["#product2Price", "#product2PriceBg", "#product2PriceTop", "#product2PriceTopText", "#product2Disclaimer"], 0.5, {x:50, ease:Sine.easeInOut}, "endScreen+=0.3")
