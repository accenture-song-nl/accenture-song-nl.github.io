...
function getAnimation(){
    ...
    masterTL.from("#text1", 0.5, {x:1000, ease:Sine.easeOut}, "start")
    masterTL.from("#text1HighlightWrapper", 0.7, {width:0, ease:Sine.easeInOut}, "start+=0.2")
    masterTL.to(["#text1", "#text1HighlightWrapper"], 0.5, {x:-1000, opacity:0, ease:Sine.easeInOut}, "start+=3")

    masterTL.add("showFrame2")
    masterTL.from("#bgBorder", 0.5, {scale:3, y:0, ease:Sine.easeOut}, "showFrame2")
    masterTL.from("#text2", 0.5, {y:300, ease:Sine.easeOut}, "showFrame2+=0.5")
    masterTL.from("#text2HighlightWrapper", 0.7, {width:0, ease:Sine.easeInOut}, "showFrame2+=1.5")
    masterTL.to(["#text2", "#text2HighlightWrapper"], 0.5, {x:-1000, opacity:0, ease:Sine.easeInOut}, "showFrame2+=3.5")
    masterTL.to(["#bgBorder", "#bg"], 0.5, {x:-1200, ease:Sine.easeIn}, "showFrame2+=3.5")

    masterTL.add("showStickerFrame")
    masterTL.from("#sticker", 0.5, {x:1400, ease:Sine.easeOut}, "showStickerFrame")
    masterTL.from("#stars1", 0.5, {x:900, ease:Sine.easeOut}, "showStickerFrame")
    masterTL.from("#stars2", 0.5, {x:2000, ease:Sine.easeOut}, "showStickerFrame")
    ...
    masterTL.from("#stars3", 0.8, {scale:0, ease:Power4.easeOut}, "showFrame3+=0.7")

    masterTL.add("endScreen")
    
    masterTL.from("#ctaLeft", 0.5, {scale:0, transformOrigin:"50% 70%", ease:Back.easeOut}, "endscreen");
