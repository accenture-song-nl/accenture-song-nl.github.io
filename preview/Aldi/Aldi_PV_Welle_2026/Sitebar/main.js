...
function getAnimation(){
    ...
    masterTL.from(["#highlight1AWrapper", "#highlight1BWrapper"], 0.5, {width:0, ease:Sine.easeInOut}, "start+=0.8")
    masterTL.from(["#highlight1CWrapper", "#highlight1DWrapper"], 0.5, {width:0, ease:Sine.easeInOut}, "start+=1.6")
    ...
    masterTL.from("#date1", 0.5, {opacity:0, ease:Sine.easeOut}, "frame2+=0.5")
    masterTL.from("#product1", 1, {x:1200, ease:Sine.easeOut}, "frame2+=0.5")
    ...
    masterTL.to("#product1", 1, {x:-1200, ease:Sine.easeIn}, "frame3")
    masterTL.to(["#badge1", "#price1"], 1, {x:-1400, ease:Sine.easeIn}, "frame3")
    masterTL.to(["#info1", "#legal1"], 0.5, {opacity:0, ease:Sine.easeIn}, "frame3")
    masterTL.to("#date1", 0.5, {opacity:0, ease:Sine.easeOut}, "frame3+=0.5")
    masterTL.from("#product2", 1, {x:1200, ease:Sine.easeOut}, "frame3+=0.5")
    masterTL.from("#date2", 0.5, {opacity:0, ease:Sine.easeOut}, "frame3+=1")
