...
function getAnimation(){
    ...
    masterTL.from([split2.words[0], split2.words[1]], 0.5, {opacity:0, x:-20, ease:Sine.easeOut});
    masterTL.from("#product", 1, {x:500, ease:Sine.easeOut}, "-=0.5");
    masterTL.from([split2.words[2], split2.words[3]], 0.5, {opacity:0, x:-20, ease:Sine.easeOut});
