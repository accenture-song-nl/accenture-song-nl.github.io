...
function loadLocalDynamic() {
    ...
    console.log(localDynamicData.campaignName)
    ...
    document.querySelector('#retentionText').innerHTML = localDynamicData.circleText;
...
function animateIntro() {
    ...
    tl.to("#bg", 0.75, {x:-160, ease:Power3.easeIn}, "start+=3");
...
function animatePayroll(ani3) {
    ...
    tl.add('start');
    tl.from("#payrollWrapper", 1, {x:160, ease:Power3.easeOut}, "start");
    ...
    if(ani3 != "line"){
        tl.to("#payrollWrapper", 1, {x:-160, ease:Power3.easeIn}, "start+=3");
    }
...
function animateHeadcount(ani3) {
    ...
    tl.add('start');
    tl.from("#headcountWrapper", 1, {x:160, ease:Power3.easeOut}, "start");
    ...
    if(ani3 != "bars"){
        tl.to("#headcountWrapper", 1, {x:-160, ease:Power3.easeIn}, "start+=3");
    }
...
function animateRetention(ani3) {
    ...
    tl.add('start');
    tl.from("#retentionWrapper", 1, {x:160, ease:Power3.easeOut}, "start");
    ...
    if(ani3 != "circle"){
        tl.to("#retentionWrapper", 1, {x:-160, ease:Power3.easeIn}, "start+=3");
    }
