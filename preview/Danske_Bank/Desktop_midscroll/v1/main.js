...
function getAnimation(){
    ...
    document.querySelector("#mainExit").addEventListener("mouseover", function(e){
        gsap.to("#cta", 0.3, {scale:1.1, ease:Sine.easeInOut});
    });

    document.querySelector("#mainExit").addEventListener("mouseout", function(e){
...
function onResize (){
    ...
    document.querySelector("#banner").classList.add(oriantation);

    var frameH = window.innerHeight;
    var vScalerH = document.querySelector("#vScaler").offsetHeight*1.2;
