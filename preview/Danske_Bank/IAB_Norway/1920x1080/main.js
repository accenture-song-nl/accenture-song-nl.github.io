...
function init() {
    ...
    document.querySelector("#mainExit").addEventListener("mouseover", function(){
        if(masterTL.progress() == 1){
            gsap.to(".cta", 0.3, {scale:1.1, transformOrigin:"1144px 672px", ease: "back.out(1.7)"})
        }
    })
...
function getAnimation(){
    ...
    masterTL.to(".squareBrandElement", brandElementSpeed, { x:-756, ease: Power2.easeInOut }, "brandElementMovement")
    ...
    masterTL.from([".bluePanel"], brandElementSpeed, { x:1200, ease: Power3.easeInOut }, "brandElementAnim")
