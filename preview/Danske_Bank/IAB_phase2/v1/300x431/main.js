...
function init() {
    ...
    document.querySelector("#mainExit").addEventListener("mouseover", function(){
        if(masterTL.progress() == 1){
            gsap.to(".cta", 0.3, {scale:1.1, transformOrigin:"50% 310px", ease: "back.out(1.7)"})
        }
    })
...
function getAnimation(){
    ...
    masterTL.to(".squareBrandElement", brandElementSpeed, { y:-185, ease: Power2.easeInOut }, "brandElementMovement")
