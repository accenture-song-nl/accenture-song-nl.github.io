...
function init() {
    ...
    document.querySelector("#mainExit").addEventListener("mouseover", function(){
        if(masterTL.progress() == 1){
            gsap.to(".cta", 0.3, {scale:1.1, transformOrigin:"50% 255px", ease: "back.out(1.7)"})
        }
    })
...
function getAnimation(){
    ...
    masterTL.to(".squareBrandElement", brandElementSpeed, { x:-386, ease: Power2.easeInOut }, "brandElementMovement")
