...
function init() {
    ...
    document.querySelector("#mainExit").addEventListener("mouseover", function(){
        if(masterTL.progress() == 1){
            gsap.to(".cta", 0.3, {scale:1.1, transformOrigin:"440px 110px", ease: "back.out(1.7)"})
        }
    })
...
function getAnimation(){
    ...
    var splitMainCopy2 = new SplitText(".mainCopy2", { type: "words,chars,lines" });
    ...
    masterTL.to(".squareBrandElement", brandElementSpeed, { x:-388, ease: Power2.easeInOut }, "brandElementMovement")
    ...
    masterTL.to(splitMainCopy.lines, brandElementSpeed, { x:-15, opacity:0, ease: Power3.easeOut, stagger:0.15 }, "brandElementAnim+="+(brandElementSpeed+2))
    masterTL.from(splitMainCopy2.lines, brandElementSpeed, { x:15, opacity:0, ease: Power3.easeOut, stagger:0.15 }, "brandElementAnim+="+(brandElementSpeed+2.5))
