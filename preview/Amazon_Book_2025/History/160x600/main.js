...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-205% 0%, 264% 0%, 34% 76%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    rolloverTL.fromTo("#spear10", 3, {x:-300, y:10}, {x:400, y:80, rotation:60, ease:Sine.easeInOut}, "start");
    ...
    masterTL.from("#spaceWrapper", 2, {clipPath:"polygon(33% 0%, 33% 0%, 34% 76%)", ease:Sine.easeInOut}, "start+=0.5");
    ...
    masterTL.fromTo("#spear3", 2,{x:-100, y:50}, {x:300, rotation:52, ease:Sine.easeInOut}, "start+=6");
    masterTL.fromTo("#spear4", 2,{x:-100, y:40}, {x:300, rotation:45, ease:Sine.easeInOut}, "start+=2");
    masterTL.fromTo("#spear5", 2,{x:-100, y:10}, {x:300, rotation:55, ease:Sine.easeInOut}, "start+=7");
    
    masterTL.fromTo("#spear6", 2, {x:-100, y:10}, {x:300, y:20, rotation:60, ease:Sine.easeInOut}, "start+=1.5");
    masterTL.fromTo("#spear7", 2, {x:-100, y:40}, {x:300, y:40, rotation:80, ease:Sine.easeInOut}, "start+=3.7");
    masterTL.fromTo("#spear8", 2, {x:-100, y:50}, {x:300, y:0, rotation:30, ease:Sine.easeInOut}, "start+=7");
...
function animateViking() {
    ...
    tl.from("#shield", 1.8, {x:-40, y:-15, yoyo:true, repeat:4, ease:Sine.easeInOut}, "start");
