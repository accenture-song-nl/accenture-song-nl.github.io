...
function getAnimation(){
    ...
    masterTL.to("#fireRight", 1.6,{scaleX:1.1, scaleY:1.3, repeat:4, yoyo:true, ease:Sine.easeInOut}, "start");
    masterTL.to("#fireRight", 2,{rotation:5, repeat:3, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    masterTL.fromTo("#spear2", 3,{x:-100, y:10}, {x:1100, rotation:50, ease:Sine.easeInOut}, "start+=5");
    masterTL.fromTo("#spear3", 3,{x:-100, y:25}, {x:1100, rotation:52, ease:Sine.easeInOut}, "start+=6");
    masterTL.fromTo("#spear4", 3,{x:-100, y:20}, {x:1100, rotation:45, ease:Sine.easeInOut}, "start+=2");
    masterTL.fromTo("#spear5", 3,{x:-100, y:5}, {x:1100, rotation:55, ease:Sine.easeInOut}, "start+=7");
    
    masterTL.fromTo("#spear6", 3, {x:-100, y:5}, {x:1100, y:10, rotation:60, ease:Sine.easeInOut}, "start+=1.5");
    masterTL.fromTo("#spear7", 3, {x:-100, y:20}, {x:1100, y:20, rotation:80, ease:Sine.easeInOut}, "start+=3.7");
    masterTL.fromTo("#spear8", 3, {x:-100, y:25}, {x:1100, y:0, rotation:30, ease:Sine.easeInOut}, "start+=7");
