...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-46% 0%, 113% 0%, 33% 68%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    masterTL.from("#spaceWrapper", 2, {clipPath:"polygon(33% 0%, 33% 0%, 33% 68%)", ease:Sine.easeInOut}, "start+=0.5");
