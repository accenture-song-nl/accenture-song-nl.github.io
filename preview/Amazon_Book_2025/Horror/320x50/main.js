...
function getAnimation(){
    ...
    masterTL.from("#bg2", 3, {y:-50, ease:Power1.easeInOut}, "start+=1");
    masterTL.from("#bg", 3, {y:-25, ease:Power1.easeInOut}, "start+=1");
    masterTL.from("#gremlin", 1, {y:50, ease:Back.easeOut}, "start+=4");
