...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-17% 0%, 85% 0%, 33% 81%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    masterTL.add("start");
    masterTL.from("#spaceWrapper", 2, {clipPath:"polygon(33% 0%, 33% 0%, 33% 81%)", ease:Sine.easeInOut}, "start+=0.5");
...
function getMousePos() {
    document.querySelector("#mainExit").addEventListener("mousemove", function (e) {
        var xPos = e.clientX/120;
        var yPos = e.clientY/30;
