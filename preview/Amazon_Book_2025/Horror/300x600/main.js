...
function getAnimation(){
    ...
    rolloverTL.to("#gremlin", 0.9, {x:-10, yoyo:true, repeat:1, ease:"bac1.inOut(1.4)"}, "start");
...
function animateSkeleton() {
    ...
    tl.add('start');
    tl.to("#skeleton", 1.9, {rotation:-20, ease:Power1.easeInOut}, "start");
