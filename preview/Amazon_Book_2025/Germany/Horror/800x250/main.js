...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-11% 0%, 81% 0%, 33% 75%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    masterTL.add("start");
    masterTL.from("#spaceWrapper", 2, {clipPath:"polygon(33% 0%, 33% 0%, 33% 75%)", ease:Sine.easeInOut}, "start+=0.5");
