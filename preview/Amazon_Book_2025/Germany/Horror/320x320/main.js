...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-98% 0%, 170% 0%, 33% 71%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    masterTL.add("start");
    masterTL.from("#spaceWrapper", 2, {clipPath:"polygon(33% 0%, 33% 0%, 33% 71%)", ease:Sine.easeInOut}, "start+=0.5");
...
function animateSkeleton() {
    ...
    tl.add('start');
    tl.to("#skeleton", 4, {rotation:-15, y:2, ease:Power1.easeInOut}, "start");
