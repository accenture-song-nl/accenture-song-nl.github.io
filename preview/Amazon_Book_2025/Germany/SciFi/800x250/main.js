...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-16% 0%, 82% 0%, 34% 72%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    masterTL.from("#spaceWrapper", 2, {clipPath:"polygon(33% 0%, 33% 0%, 34% 72%)", ease:Sine.easeInOut}, "start+=0.5");
...
function animateAsteroid() {
    ...
    tl.to("#asteroid", 2.5, {x:-80, yoyo:true, ease:Sine.easeInOut}, "start+=1.25");
