...
function getAnimation(){
    ...
    masterTL.from("#bg", 3, {y:50, ease:Power1.easeInOut}, "start+=0.5");
    masterTL.from("#mountain", 3, {y:100, ease:Power1.easeInOut}, "start+=0.5");
    masterTL.from("#right", 3, {y:150, ease:Power1.easeInOut}, "start+=0.5");
