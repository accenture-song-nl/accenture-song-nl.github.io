...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-18% -5%, 84% 0%, 33% 73%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    masterTL.add("start");
    masterTL.from("#spaceWrapper", 2, {clipPath:"polygon(33% -5%, 33% 0%, 33% 73%)", ease:Sine.easeInOut}, "start+=0.5");
...
function animateWizard() {
    ...
    tl.add('start');
    tl.from("#wizardWrapper", 1.8, {x:50, y:150, ease:Sine.easeOut}, "start");
