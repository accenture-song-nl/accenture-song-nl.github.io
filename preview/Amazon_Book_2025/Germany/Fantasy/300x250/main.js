...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-68% 0%, 138% 0%, 33% 74%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    masterTL.add("start");
    masterTL.from("#spaceWrapper", 2, {clipPath:"polygon(33% 0%, 33% 0%, 33% 74%)", ease:Sine.easeInOut}, "start+=0.5");
...
function animateCreature() {
    ...
    tl.to("#creatureWrapper", 0.75, {y:-10, ease:Sine.easeInOut, repeat:6, yoyo:true}, "start");
