...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-14% 0%, 82% 0%, 33.5% 73%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    masterTL.add("start");
    masterTL.from("#spaceWrapper", 2, {clipPath:"polygon(33% 0%, 33% 0%, 33.5% 73%)", ease:Sine.easeInOut}, "start+=0.5");
    ...
    masterTL.fromTo("#heliWrapper", 7, {scale:0, x:-60}, {x:358, scale:1.5, ease:Sine.easeOut}, "heli");
