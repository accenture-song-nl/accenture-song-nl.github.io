...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-198% 0%, 271% 0%, 33% 76%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    masterTL.from("#runners", 2, {opacity:0, y:30, ease:Sine.easeInOut}, "heli+=3");
