...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-15% 0%, 84% 0%, 33% 72%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    masterTL.add("start");
    masterTL.from("#spaceWrapper", 2, {clipPath:"polygon(33% 0%, 33% 0%, 33% 72%)", ease:Sine.easeInOut}, "start+=0.5");
    ...
    masterTL.from("#flame1", 0.02, {rotationY:180, rotation:10, repeat:15, yoyo:true, repeatDelay:0.19, ease:Sine.easeOut}, "start+=4.3");
