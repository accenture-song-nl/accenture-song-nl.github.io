...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-45% 0%, 112% 0%, 33% 68%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    masterTL.from("#scarfWrapper3", 2, {width:0, ease:Sine.easeInOut}, "start+=1.4");
    masterTL.from("#scarfWrapper2", 1.5, {width:0, ease:Sine.easeInOut}, "start+=2.8");
    masterTL.from("#scarfWrapper1", 1.8, {width:0, ease:Sine.easeInOut}, "start+=3.7");
    ...
    masterTL.from("#flame1", 0.02, {rotationY:180, rotation:2, repeat:15, yoyo:true, repeatDelay:0.19, ease:Sine.easeOut}, "start+=4.3");
