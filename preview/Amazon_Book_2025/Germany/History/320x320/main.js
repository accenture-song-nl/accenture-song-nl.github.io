...
function getAnimation(){
    ...
    rolloverTL.to("#spaceWrapper", 0.5, {clipPath:"polygon(-115% 0%, 183% 0%, 33.5% 70%)", repeat:1, yoyo:true, ease:Sine.easeInOut}, "start");
    ...
    rolloverTL.fromTo("#spear10", 3, {x:-300, y:10}, {x:300, y:80, rotation:60, ease:Sine.easeInOut}, "start");
    ...
    masterTL.from("#spaceWrapper", 2, {clipPath:"polygon(33% 0%, 33% 0%, 33.5% 70%)", ease:Sine.easeInOut}, "start+=0.5");
