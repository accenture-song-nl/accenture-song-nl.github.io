...
function getAnimation(){
    ...
    masterTL.add("start");
    masterTL.from("#bg1", .5, {scale:1.1, ease:Sine.easeInOut}, "start");
    ...
    masterTL.to("#bg1", .5, {x:-970, ease:Sine.easeInOut}, "frame2");
    masterTL.from("#bg2", .5, {x:970, ease:Sine.easeInOut}, "frame2");
    ...
    masterTL.to("#bg2", .5, {x:-970, ease:Sine.easeInOut}, "frame3");
    masterTL.from("#bg3", .5, {x:970, ease:Sine.easeInOut}, "frame3");
    masterTL.to("#bg3", 3, {scale:1.1, ease:Sine.easeInOut}, "frame3+=0.5");
    masterTL.from("#text3", 0.5, {x:-970, ease:Sine.easeOut}, "frame3+=0.5");
