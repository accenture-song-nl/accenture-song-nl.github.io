...
function getAnimation(){
    ...
    masterTL.from("#bg1", 0.3, {scale:1.4, ease:Sine.easeInOut}, "start")
    masterTL.to("#bg1", 4, {scale:1.2, transformOrigin:"50%, 50%", ease:Sine.easeInOut}, "start+=0.3");
    ...
    masterTL.to("#bg1", 0.3, {scale:1.4, ease:Sine.easeInOut}, "switchBg")
    ...
    masterTL.to("#bg2", 4, {scale:1.1, transformOrigin:"50%, 80%", ease:Sine.easeInOut}, "switchBg+=0.3")
