...
function getAnimation(){
    ...
    masterTL.from("#bg1", 0.3, {scale:1.3, ease:Sine.easeInOut}, "start")
    masterTL.to("#bg1", 4, {scale:1.2, transformOrigin:"50%, 70%", ease:Sine.easeInOut}, "start+=0.3");
    ...
    masterTL.to("#bg2", 4, {scale:1.075, transformOrigin:"50%, 80%", ease:Sine.easeInOut}, "switchBg+=0.3")
