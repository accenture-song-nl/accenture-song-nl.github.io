...
function getAnimation(){
    ...
    masterTL.from("#bg1", 0.3, {scale:1.2, ease:Sine.easeInOut}, "start")
    masterTL.to("#bg1", 4, {scale:1.075, transformOrigin:"50%, 50%", ease:Sine.easeInOut}, "start+=0.3");
    masterTL.from("#text1A", 0.3, {x:-250, ease:Sine.easeInOut}, "start+=0.5")
    masterTL.from("#text1B", 0.3, {x:-250, ease:Sine.easeInOut}, "start+=0.65")
    
    masterTL.add("switchBg", "-=0.3")
    masterTL.to("#bg1", 0.3, {scale:1.2, ease:Sine.easeInOut}, "switchBg")
    masterTL.to(["#text1A", "#text1B"], 0.3, {opacity:0, ease:Sine.easeInOut}, "switchBg")
    masterTL.from("#bg2", 0.3, {scale:1.2, ease:Sine.easeInOut},"switchBg")
    masterTL.to("#bg1", 0.15, {opacity:0, ease:Sine.easeInOut}, "switchBg+=0.15")
    masterTL.to("#bg2", 4, {scale:1.05, transformOrigin:"50%, 80%", ease:Sine.easeInOut}, "switchBg+=0.3")
    masterTL.from("#text2A", 0.3, {x:-250, ease:Sine.easeInOut}, "switchBg+=0.5")
    masterTL.from("#text2B", 0.3, {x:-250, ease:Sine.easeInOut}, "switchBg+=0.65")
    masterTL.from("#text2C", 0.3, {x:-250, ease:Sine.easeInOut}, "switchBg+=0.8")
