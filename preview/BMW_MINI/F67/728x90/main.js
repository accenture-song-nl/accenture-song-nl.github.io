...
function getAnimation(){
    ...
    masterTL.from("#bg1", 0.3, {scale:1.1, ease:Sine.easeInOut}, "start")
    masterTL.to("#bg1", 4, {scale:1.05, transformOrigin:"60%, 50%", ease:Sine.easeInOut}, "start+=0.3");
    ...
    masterTL.from("#text2A", 0.3, {x:-400, ease:Sine.easeInOut}, "switchBg+=0.5")
    masterTL.from("#text2B", 0.3, {x:-400, ease:Sine.easeInOut}, "switchBg+=0.65")
